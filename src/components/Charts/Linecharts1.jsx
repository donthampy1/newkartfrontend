...
console.log(data,category,"lnlnnlnjnn")
let linedata = {};
...
(data && data.length) ? data.reduce((result, order) => {
    ...
    const orderCategoryTotal = order.products.reduce((sum, product) => {
    ...
    linedata[weekKey] += orderCategoryTotal;
...
const lineChartData = {
    ...
    datasets: [
      {
        label: '',
        data: Object.values(linedata) || [0,0,0,0,0],
        fill: true,
