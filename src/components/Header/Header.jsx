...
function Header() {
  ...
  return (
    <>
      <AppBar
        elevation={1}
        sx={{ backgroundColor: isDarkMode ? "white" : "black" }}
      >
        <div
          className={`flex items-center justify-around font-semibold text-lg ${
        ...
        >
          <div className="flex flex-row    text-xl">
            <DevicesOutlinedIcon
              sx={{
                ...
                "& path": {
                  strokeWidth: 0.01, //Control Thickness of mui logo
                },
              }}
            />
          ...
          <ul
            className={`hidden py-6 md:flex gap-4 text-sm ${
              isDarkMode ? "text-gray-700" : "text-white"
            }`}
          >
